...
const GlassesDetails: React.FC<GlassesDetailsProps> = ({ isOpen, onClose, glassUrl, glassImage }) => {
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] sm:w-[460px] max-h-[85vh] bg-white shadow-2xl rounded-2xl z-[1002] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex-none bg-white border-b px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className="text-gray-500 hover:text-gray-700 focus:outline-none p-2 hover:bg-gray-100 rounded-full transition-colors"
            >
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            ...
            <div className="bg-red-50 text-red-500 p-4 rounded-lg m-4 text-center">{error}</div>
          ) : details ? (
            <div className="divide-y divide-gray-100">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="text-center space-y-3">
                  <h3 className="text-xl font-bold text-gray-900 line-clamp-2">{details?.title || 'Ürün Adı Yok'}</h3>
                  <div className="flex items-center justify-center space-x-1">
                    ...
                    {details?.price && <span className="text-xl font-semibold text-blue-600">TL</span>}
                  </div>
                </div>
                ...
                <a
                  ...
                  className="block w-full bg-blue-600 text-white text-center py-3.5 rounded-xl hover:bg-blue-700 transition-colors font-semibold shadow-md hover:shadow-lg text-lg"
                >
                  Ürüne Git
                </a>
              </div>
